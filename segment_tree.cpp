...
int main(){
	...
	cout << "Sum btw 0 and 4 : " << query(tree, 0, 4, 0, 4, 0) << endl;
	cout << "Sum btw 1 and 3 : " << query(tree, 0, 4, 1, 3, 0) << endl;
	cout << "Sum btw 3 and 4 : " << query(tree, 0, 4, 3, 4, 0) << endl;
	return 0;
}